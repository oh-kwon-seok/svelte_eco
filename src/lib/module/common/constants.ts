...
import { bookmarkEstimateModalOpen,bookmarkEstimateSubitemSelect,bookmarkEstimateSubItemSearchModalOpen,bookmarkEstimateSubSelectDelete} from '$lib/store/bookmark_estimate/function';
...
const MODAL_TABLE_HEADER_CONFIG : any = {
    ...
    bookmark_estimate_search : [
        ...
        cellClick:function(e : any, cell:any){
            let row = cell.getRow();
            if(cell){
                bookmarkEstimateSubitemSelect(cell);
            }else{
    ...
    bookmark_estimate_sub : [
        ...
        cellClick:function(e : any, cell:any){
                ...
                if(row){
                    ...
                    bookmarkEstimateSubItemSearchModalOpen('bookmark_estimate_search',row);
                }else{
    ...
    
        {
            ...
            formatter: function (cell:any, formatterParams:any, onRendered:any) {
                ...
                deleteButton.addEventListener("click", function () {
                    // let add_qty = parseInt(rowData.qty) + 1;
                    // row.update({qty : add_qty});
                    bookmarkEstimateSubSelectDelete(cell);
                });
...
equipment : [
    ...
    bookmark_estimate : [
        ...
        cellClick:function(e : any, cell:any){
            let row = cell.getRow();
            if(row){
                bookmarkEstimateModalOpen(row.getData(),"update");
            }else{
